...
# APP/DialogFlow
ENV MARVIN_APP_DIALOGFLOW_ACCESS_TOKEN=NOTOKEN
ENV MARVIN_APP_DIALOGFLOW_HOST=api.dialogflow.com
ENV MARVIN_APP_DIALOGFLOW_PORT=443
ENV MARVIN_APP_DIALOGFLOW_ROOT_URL=/v1
# GUILD
